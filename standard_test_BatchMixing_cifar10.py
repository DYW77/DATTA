                ...
                for domain_type in corruption_domain:
                    for i, domain_order in enumerate(data_names_choice):
                        # for batch_size in bs1:
                            ...
                            args_note.root_path = "./Resnet26_in_cifar10_inter_new"
                            args_note.model_name="resnet26"
                            args_note.job_name = f"{method}-{all_data_name[0]}-{args_note.model_name}"
                            ...
                            print("!!!!!!!!!!!!!!!!!!!!", all_data_name[0])
                            args_note.data_names = domain_order[0]
                            args_note.base_data_name = all_data_name[0]
                            args_note.src_data_name = all_data_name[0]

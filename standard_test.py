...
all_data_name = ["cifar10","cifar100","imagenet"]#,"imagenet"  # ,"imagenet","cifar100","cifar100"
# seed = [2022]
# ckpt_path = [
...
#     print(domain_order[0])
#     print(all_data_name[i])
# print(data_names_choice[0])
def one_test_thread():
                ...
                for domain_type in corruption_domain:
                    for i, domain_order in enumerate(data_names_choice):
                        # for batch_size in bs1:
                            ...
                            args_note.root_path = "./IABN-standard-test/cross"
                            args_note.job_name = f"{method}-{all_data_name[i]}-{domain_type}"
